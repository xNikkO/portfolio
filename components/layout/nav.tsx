...
function NavThemeToggle(): ReactNode {
  ...
  return (
    <button
      ...
      className="focus-ring bg-background/40 ring-foreground/8 relative inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full ring-1 transition-colors"
    >
